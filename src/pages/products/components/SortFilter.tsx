    ...
    <div className='bg-gray-300/40 py-4 px-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex items-center flex-wrap gap-2'>
          ...
          <button className='h-8 px-4 capitalize bg-primary_orange text-white text-sm hover:bg-primary_orange/80 text-center'>
            Phổ biến
          </button>
        ...
        <div className='flex items-center'>
          <div>
            <span className='text-primary_orange'>1</span>
            <span>/2</span>
          </div>
          <div className='ml-2'>
